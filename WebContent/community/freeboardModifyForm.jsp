...
Connection conn = null;
	...
	try {
		...
		pstmt = conn.prepareStatement(
			"SELECT NUM, TITLE, CONTENTS, WRITER, HIT, REG_DATE FROM freeboard "+ 
			"WHERE NUM = ?");
...
<head>
	...
	<script type="text/javascript">
		...
		function boardModifyCheck() {
			var form = document.freeboardModifyForm;
			if (form.title.value == '') {
				alert('제목을 입력하세요.');
				form.title.focus();
				return false;
		...
		<contents>
			<div class='contentsTotal'>
				...
				<div class='contentsBox'>
						<form name="freeboardModifyForm" action="boardProcess.jsp" method="post" onsubmit="return boardModifyCheck();">
						<input type="hidden" name="mode" value="freeM" />
						...
						<p align="right" style= width:600px;>
							<input class='small secondary button' type="button" value="목록" onclick="goUrl('freeboard.jsp?pageNum=<%=pageNum%>&amp;searchType=<%=searchType%>&amp;searchText=<%=searchText%>');" />
