...
<head>
	...
	<script type="text/javascript">
		...
		function boardModifyCheck() {
			var form = document.newsboardModifyForm;
			if (form.title.value == '') {
				alert('제목을 입력하세요.');
				form.title.focus();
				return false;
		...
		<contents>
			<div class='contentsTotal'>
				...
				<div class='contentsBox'>
						<form name="newsboardModifyForm" action="boardProcess.jsp" method="post" onsubmit="return boardModifyCheck();">
						<input type="hidden" name="mode" value="newsM" />
						...
						<p align="right" style= width:600px;>
							<input class='small secondary button' type="button" value="목록" onclick="goUrl('newsboard.jsp?pageNum=<%=pageNum%>&amp;searchType=<%=searchType%>&amp;searchText=<%=searchText%>');" />
