		...
		<contents>
			<div class='contentsTotal'>
				...
				<div class='contentsBox'>
						<form name="noticeboardWriteForm" action="boardProcess.jsp" method="post" onsubmit="return boardWriteCheck();">
						<input type="hidden" name="mode" value="noticeW" />
						...
						<p align="right" style= width:600px;>
							<input class='small secondary button' type="button" value="목록" onclick="goUrl('noticeboard.jsp');" />
