...
<head>
	...
	<script type="text/javascript">
		...
		function boardWriteCheck() {
			var form = document.qnaboardWriteForm;
			if (form.title.value == '') {
				alert('제목을 입력하세요.');
				form.title.focus();
				return false;
		...
		<contents>
			<div class='contentsTotal'>
				...
				<div class='contentsBox'>
						<form name="qnaboardWriteForm" action="boardProcess.jsp" method="post" onsubmit="return boardWriteCheck();">
						<input type="hidden" name="mode" value="qnaW" />
						...
						<p align="right" style= width:600px;>
							<input class='small secondary button' type="button" value="목록" onclick="goUrl('qnaboard.jsp');" />
